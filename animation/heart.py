...
class ProceduralWorld:
    def __init__(self):
        ...
        # 2. Heart Parameters
        self.base_scale = random.uniform(12.8, 13.8)
        self.pulse_speed = random.uniform(2.2, 2.8)
        self.pulse_intensity = random.uniform(0.08, 0.12)
        ...
        # Orbit Parameters
        self.orbit_a = random.uniform(33.0, 36.5)
        self.orbit_b = random.uniform(10.5, 12.2)
    ...
    def get_heart_surface(self, px, py, scale):
        ...
        gz = self.heart_function(hx, hit_y, hz + eps) - self.heart_function(hx, hit_y, hz - eps)
...
def render_frame(world, t):
    ...
    cx = WIDTH / 2.0 + math.sin(t * world.bob_x) * 0.7
    cy = HEIGHT / 2.0 + math.cos(t * world.bob_y) * 0.35
    ...
    for dy in range(-box_h, box_h + 1):
        ...
        for dx in range(-box_w, box_w + 1):
            ...
            if pz is not None:
                ...
                color_buf[y_idx][x_idx] = world.purple_gradient(intensity, is_highlight=(spec > 0.28))
